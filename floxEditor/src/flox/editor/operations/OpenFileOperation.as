...
package flox.editor.operations
{
	...
	import flox.editor.ui.panels.OpenWithPanel;
	...
	public class OpenFileOperation extends EventDispatcher implements IAsynchronousOperation
	{
		...
		public function execute():void
		{
			...
			var contexts:Vector.<IContext> = FloxEditor.contextManager.getContextsOfType(IEditorContext);
			for each ( var context:IEditorContext in contexts )
			{
				...
				{
					FloxEditor.viewManager.showVisualContext( context );
		...
		protected function doesFileExistOperationCompleteHandler( event:Event ):void
		{
			...
			var editorFactories:Vector.<IResource> = FloxApp.resourceManager.getResourcesOfType(EditorFactory);
