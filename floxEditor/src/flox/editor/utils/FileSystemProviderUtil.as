package flox.editor.utils
{
	...
	public class FileSystemProviderUtil
	{
		static public function getProjectDirectoryURI(cadetFileURI:URI):URI
		{
			...
			var provider:IFileSystemProvider = FloxApp.fileSystemProvider.getFileSystemProviderForURI(cadetFileURI);
		...
		{
			var providerA:IFileSystemProvider = FloxApp.fileSystemProvider.getFileSystemProviderForURI(uriA);
			var providerB:IFileSystemProvider = FloxApp.fileSystemProvider.getFileSystemProviderForURI(uriB);
