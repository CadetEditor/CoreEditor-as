...
package flox.app.validators
{
	...
	[Event( type="flox.app.events.CollectionValidatorEvent", name="validItemsChanged" )]
	...
	public class CollectionValidator extends AbstractValidator
	{
		...
		public function CollectionValidator( collection:flox.core.data.ArrayCollection = null, validType:Class = null, min:uint = 1, max:uint = uint.MAX_VALUE )
		{
			oldCollection = [];
