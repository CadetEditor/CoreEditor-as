...
package flox.app.managers
{
	...
	[Event(name="change", 					type="flox.app.events.OperationManagerEvent")]
	[Event(name="operationAdded", 			type="flox.app.events.OperationManagerEvent")]
	[Event(name="operationComplete", 		type="flox.app.events.OperationManagerEvent")]
	[Event(name="operationBegin", 			type="flox.app.events.OperationManagerEvent")]
	[Event(name="allOperationsComplete", 	type="flox.app.events.OperationManagerEvent")]
	[Event(name="operationProgress", 		type="flox.app.events.OperationManagerEvent")]
