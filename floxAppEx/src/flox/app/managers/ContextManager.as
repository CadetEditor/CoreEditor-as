...
package flox.app.managers
{
	...
	[Event(type="flox.app.events.ContextManagerEvent", name="currentContextChanged" )];
	[Event(type="flox.app.events.ContextManagerEvent", name="contextAdded")];
	[Event(type="flox.app.events.ContextManagerEvent", name="contextRemoved")];
