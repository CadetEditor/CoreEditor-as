...
package core.app.managers
{
	...
	[Event(name="change", 					type="core.app.events.OperationManagerEvent")]
	[Event(name="operationAdded", 			type="core.app.events.OperationManagerEvent")]
	[Event(name="operationComplete", 		type="core.app.events.OperationManagerEvent")]
	[Event(name="operationBegin", 			type="core.app.events.OperationManagerEvent")]
	[Event(name="allOperationsComplete", 	type="core.app.events.OperationManagerEvent")]
	[Event(name="operationProgress", 		type="core.app.events.OperationManagerEvent")]
