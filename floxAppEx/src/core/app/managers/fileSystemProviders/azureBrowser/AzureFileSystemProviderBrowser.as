...
package core.app.managers.fileSystemProviders.azureBrowser
{
	...
	public class AzureFileSystemProviderBrowser extends EventDispatcher implements IFileSystemProvider
	{
		...
		public function AzureFileSystemProviderBrowser( id:String, label:String, endPoint:String, sas:String, hostUri:String )
		{
			_id = id;
			_label = label;
		...
		{
			var operation:WriteFileOperation = new WriteFileOperation( uri, bytes, endPoint, sas, hostUri, this );
			initOperation( operation );
			return operation;
		}
		...
		{
			var operation:CreateDirectoryOperation = new CreateDirectoryOperation( uri, endPoint, sas, hostUri, this );
			initOperation( operation );
			return operation;
		}
		...
		{
			var operation:DeleteFileOperation = new DeleteFileOperation( uri, endPoint, sas, hostUri, this );
			initOperation( operation );
			return operation;
		}
