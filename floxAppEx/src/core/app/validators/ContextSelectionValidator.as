...
package core.app.validators
{
	...
	[Event(type="core.app.events.ContextSelectionValidatorEvent", name="validSelectionChanged")]
	[Event(type="core.app.events.ContextValidatorEvent", name="contextChanged" )]
