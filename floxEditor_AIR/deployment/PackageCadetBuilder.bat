...
set APP_XML=cadetBuilder-app.xml 
set FILE_OR_DIR=-C ..\bin-debug .

set SOURCE_CONFIG_PATH="..\bin-debug\cadetBuilderConfig.xml"
set TARGET_CONFIG_PATH="..\bin-debug\config.xml"

set CERTIFICATE="Certificate.pfx"
set AIR_FILE=CadetBuilder.air
