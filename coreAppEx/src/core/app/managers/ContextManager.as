...
package core.app.managers
{
	...
	[Event(type="core.app.events.ContextManagerEvent", name="currentContextChanged" )];
	[Event(type="core.app.events.ContextManagerEvent", name="contextAdded")];
	[Event(type="core.app.events.ContextManagerEvent", name="contextRemoved")];
