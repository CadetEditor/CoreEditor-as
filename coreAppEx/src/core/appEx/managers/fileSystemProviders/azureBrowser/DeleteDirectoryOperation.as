...
package core.appEx.managers.fileSystemProviders.azureBrowser
{
	...
	internal class DeleteDirectoryOperation extends AzureFileSystemProviderOperation
	{
		...
		public function DeleteDirectoryOperation(uri:core.app.entities.URI, endPoint:String, sas:String, hostUri:String, fileSystemProvider:IFileSystemProvider )
		{
		...
		private function getDirectoryContentsCompleteHandler( event:Event ):void
		{
			...
			{
				var fileToDelete:core.app.entities.URI = getDirectoryContentsOperation.contents[i];
