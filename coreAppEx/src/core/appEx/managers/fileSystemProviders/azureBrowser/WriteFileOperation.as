...
package core.appEx.managers.fileSystemProviders.azureBrowser
{
	...
	internal class WriteFileOperation extends AzureFileSystemProviderOperation implements IWriteFileOperation
	{
		...
		public function WriteFileOperation( uri:core.app.entities.URI, bytes:ByteArray, endPoint:String, sas:String, hostUri:String, fileSystemProvider:IFileSystemProvider )
		{
